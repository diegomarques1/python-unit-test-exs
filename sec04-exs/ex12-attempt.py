...
class TestCalculateAverage(unittest.TestCase):
    def test_calculate_average_valid_input(self):
        ...
        self.assertEqual(calculate_average([2.5, 5.5, 8.5]), 5.5)
        self.assertEqual(calculate_average([-2, -1, 0, 1, 2]), 0)
    ...
    def test_calculate_average_invalid_input(self):
        self.assertRaises(TypeError, calculate_average, [1, 2, "3", "4", 5])
